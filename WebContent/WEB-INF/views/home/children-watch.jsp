...
<div class="container">
    <h3 style="color:#970000;font-weight:bold;font-size: 20px">Top 10 đồng hồ trẻ em nổi bật</h3>
</div>
...
<!-- xong div top 10 noi bat -->
    ...
    <div class="container" style="background-color: white; padding: 20px 0px;">
        ...
        <hr>
        <h4 class="text-center" style="color: brown;">ĐỒNG HỒ TRẺ EM</h4>
        <hr>

        
     			<c:forEach var="p" items="${productschildren}">
