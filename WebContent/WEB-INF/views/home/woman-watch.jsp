    ...
    <nav class="navbar navbar-default navbar-inverse navbar-fixed-top header-web" role="navigation">
    	<div class="container-fluid header-web2">
    		...
    		<ul class="nav navbar-nav">
				...
				<li><a href="home/childrent-watch/${user.username}.htm">Đồng hồ trẻ em</a></li>
    		</ul>
...
<div class="container">
    <h3 style="color:#970000;font-weight:bold;font-size: 20px">Top 10 đồng hồ nữ nổi bật</h3>
</div>
...
<!-- xong div top 10 noi bat -->
    ...
    <div class="container" style="background-color: white; padding: 20px 0px;">
        ...
        <hr>
        <h4 class="text-center" style="color: brown;">ĐỒNG HỒ THỜI TRANG NỮ</h4>
        <hr>

        
     			<c:forEach var="p" items="${productswoman}">
