...
<html>
	...
	<div class="text-center">
		<h3 style="color:darkblue;">Xác thực</h3>
		<p style="color:red;">${message}</p>
	</div>
	
				<c:set var="xacthuc" scope="session" value=""/>
    			<form action="user/confirm/${username}.htm">
    				<input type="hidden" name="ma" value="${ma}" class="form-control" placeholder="Mã...">  				
    				<div class="form-group">
    				<h4 class="text-center" style="margin-top: 20px;margin-bottom: 10px;">Nhập mã xác thực</h4>
    					<input type="text" name="xacthuc" value="${xacthuc}" class="form-control" placeholder="Mã xác thực...">
    				</div>
